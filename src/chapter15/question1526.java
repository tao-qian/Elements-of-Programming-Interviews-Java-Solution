...
public class question1526 {
	...
	public static void main(String[] args)
	{
		...
		Collections.sort(chars,new Comparator<Character>(){
			...
			public int compare(Character o1, Character o2) {
				return (int)Math.signum(frequencies.get(o1) - frequencies.get(o2));
			}});
		for(Character c : chars)
		{
			System.out.println(c+" : "+frequencies.get(c)+" "+code.get(c));
		}
	}
	...
	public static class HuffmanNode implements Comparable<HuffmanNode>
	{
		...
		public int compareTo(HuffmanNode n)
		{
			...
			// Just so that nodes with the same frequencies will not be thought to be the same
			return hashCode()-n.hashCode();
		}
	}
	
	public static HashMap<Character, String> huffmanCode(HashMap<Character, Double> frequencies)
	{
	...
	public static void GenerateHuffmanCode(HuffmanNode root, LinkedList<String> sequence, boolean isLeft , HashMap<Character, String> result)
	{
		if(isLeft)
		{
			sequence.addLast("1");
